...
(function() {
    ...
    a.prototype.init = function(b) {
        ...
        this.editorInstance.once("loaded", function() { c.fullToolbarEditor.init(function() { c._onInit(b); if ("function" == typeof c.onRefresh) c.onRefresh() }, c.editorInstance.config) });
    ...
    a.prototype._onInit = function(b, c) {
        ...
        if (!this.actualConfig.toolbarGroups &&
            ...
            for (var a = this.actualConfig, d = this.editorInstance.toolbar, g = [], f = d.length, k = 0; k < f; k++) { var h = d[k]; "string" == typeof h ? g.push(h) : g.push({ name: h.name, groups: h.groups ? h.groups.slice() : [] }) }
            a.toolbarGroups = g
        }
